...
class Config:
    def __init__(self):
        ...
        self.ARTISTBOTS_API_URL: str = getenv("ARTISTBOTS_API_URL", "https://github.com/CyberPixelPro/AviaxMusic")
        self.ARTISTBOTS_KEY: str = getenv("ARTISTBOTS_KEY", "30DxNexGenBots6a45bd")
